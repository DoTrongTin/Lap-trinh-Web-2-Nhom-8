...
if($idnhaxuatban){
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if(updateNhaXuatBanById($idnhaxuatban, $trangthai)){
            echo "<script>
...
?>
        ...
        <div class="container">
            <form action="../controller/index.php?pg=suanhaxuatban" method="post">
                ...
                <input type="text" name="publisherName" value="<?=$nhaxuatban['tennxb']?>" readonly>

                <label for="email"><b>Email</b></label>
                <input type="email" name="email" value="<?=$nhaxuatban['email']?>" readonly>

                <label for="phoneNumber"><b>Số điện thoại</b></label>
                <input type="text" name="phoneNumber" value="<?=$nhaxuatban['sodienthoai']?>" readonly>

                <label for="address"><b>Địa chỉ</b></label>
                <input type="text" name="address" value="<?=$nhaxuatban['diachi']?>" readonly>
