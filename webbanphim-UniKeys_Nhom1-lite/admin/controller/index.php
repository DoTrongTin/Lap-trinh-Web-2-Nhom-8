<?php
    ...
    switch ($page) {
        ...
        case 'xoatheloai':
            ...
            break;
        case 'themthuonghieu':
            include '../view/themthuonghieu.php';
            break;
        case 'suathuonghieu':
            include '../view/suathuonghieu.php';
            break;
        case 'xoathuonghieu':
            include '../view/xoathuonghieu.php';
            break;
        case 'themnhaphanphoi':
            include '../view/themnhaphanphoi.php';
            break;
        case 'suanhaphanphoi':
            include '../view/suanhaphanphoi.php';
            break;
        case 'xoanhaphanphoi':
            include '../view/xoanhaphanphoi.php';
            break;
