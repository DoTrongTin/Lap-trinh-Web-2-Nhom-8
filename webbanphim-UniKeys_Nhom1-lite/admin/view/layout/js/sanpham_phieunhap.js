            ...
            data.data.forEach(product => {
                const row = `
                    <tr>
                        ...
                        <td>${product.idbanphim}</td>
                        <td>${product.tenbanphim}</td>
                        <td>${product.idthuonghieu}</td>
                        <td>${product.idnhaphaphoi}</td>
...
function fillFormWithProduct(product) {
    document.getElementById("IDSach").value = product.idbanphim || '';
    document.getElementById("tenSach").value = product.tenbanphim || '';
    document.getElementById("tacGia").value = product.idthuonghieu || '';
    document.getElementById("nxb").value = product.idnhaphaphoi || '';
