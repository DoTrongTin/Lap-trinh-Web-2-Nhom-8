            ...
            data.data.forEach(product => {
                const row = `
                    <tr>
                        ...
                        <td>
                            <a href="../controller/index.php?pg=suasach&idbanphim=${product.idbanphim}">
                                <img src="../view/layout/logo-icon/update-icon.png" alt="Sửa" style="width:20px; height:20px;">
                            </a>
                        </td>
                        <td>
                            <a href="../controller/index.php?pg=xoasach&idbanphim=${product.idbanphim}" onclick="return confirm('Bạn có chắc muốn xóa sách ${product.tenbanphim} không?')">
