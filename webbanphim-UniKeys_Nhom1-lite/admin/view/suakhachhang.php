...
if($idkhachhang){
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if(updateKhachHangById($idkhachhang, $trangthai)){
...
?>
        ...
        <div class="container">
            ...
            <form action="../controller/index.php?pg=suakhachhang" method="post">
                ...
                <input type="text" name="ten" value="<?=$customer['ten']?>" readonly>

                <label for="email"><b>Email</b></label>
                <input type="email" name="email" value="<?=$customer['email']?>" readonly>

                <label for="phoneNumber"><b>Số điện thoại</b></label>
                <input type="text" name="phoneNumber" value="<?=$customer['sodienthoai']?>" readonly>
