...
<div class="right-content">
        <div class="tabs">
            <button class="tab-button active" data-tab="tab1">Sản phẩm</button>
            <!-- <button class="tab-button" data-tab="tab15">Thể loại</button> -->
            <button class="tab-button" data-tab="tab3">Thương hiệu</button>
            <button class="tab-button" data-tab="tab4">Nhà phân phối</button>
            <!-- <button class="tab-button" data-tab="tab5">Hình ảnh sản phẩm</button> -->
        </div>
    ...
    <!-- <script src="../view/layout/js/sanpham.js"></script> -->
            ...
            <div id="tab3" class="tab-content">
                ...
                <div class="actions">
                    ...
                    <button onclick="location.href='../controller/index.php?pg=themthuonghieu';">Thêm</button>
                </div>
                <table>
                    <thead>
                        <tr>
            ...
            <div id="tab4" class="tab-content">
                ...
                <div class="actions">
                    ...
                    <button onclick="location.href='../controller/index.php?pg=themnhaphanphoi';">Thêm</button>
                </div>
                <table>
                    <thead>
                        <tr>
...
<script src="../view/layout/js/thuonghieu.js"></script>
