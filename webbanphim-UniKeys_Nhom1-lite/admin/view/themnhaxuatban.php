<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {  
        ...
        if ($result['tenNXB']) {
            echo "<script>alert('Tên nhà phân phối đã tồn tại! Vui lòng nhập lại.');</script>";
            ...
            // Nếu không có trùng lặp, thêm nhà phân phối mới
            if (themNXB($tenNXB, $email, $sdt, $diachi)) {
                echo "<script>alert('Thêm nhà phân phối thành công!'); window.location.href = '../controller/index.php?pg=sanpham&tabId=tab4';</script>";
            } else {
                echo "<script>alert('Thêm nhà phân phối thất bại! Vui lòng thử lại.');</script>";
            }
        }
    }    
?>
        ...
        <div class="container">
            <form action="../controller/index.php?pg=themnhaphanphoi" method="post">
                ...
                <input type="text" placeholder="Nhập tên nhà phân phối" name="publisherName" required
    ...
    <script src="../view/layout/js/nhaphanphoi.js"></script>
</body>
</html>
