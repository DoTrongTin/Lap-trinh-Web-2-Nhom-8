            ...
            if($result){
                if($trangthai == '3'){
                    foreach ($cthds as $cthd){
                        $idbanphim = $cthd['idbanphim'];
                        $slsachgoc = getDataSanPhamTheoId($idbanphim);
                        $slban = $cthd['soluong'];
                        $slconlai = $slsachgoc['sltonkho'] + $slban;
                        updateSlTonKhoTheoId($idbanphim, $slconlai);
                    }
                }
                echo "<script>
                        ...
                        <table>
                            ...
                            <tbody>
                                <?php foreach($cthds as $cthd): ?>
                                    <tr>
                                        <td><?=$cthd['idbanphim']?></td>
                                        <td><?=$cthd['tenbanphim']?></td>
                                        <td><?=$cthd['idthuonghieu']?></td>
                                        <td><?=$cthd['idnhaphaphoi']?></td>
                                        <td><?=$cthd['idctdanhmuc']?></td>
                                        <td><?=$cthd['soluong']?></td>
                                        <td><?= number_format($cthd['dongia'], 0, '.', '.') ?> đ</td>
