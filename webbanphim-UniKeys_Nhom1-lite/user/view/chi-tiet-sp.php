...
<aside class="block-main-content">
    <div class="block-breadcrumbs">
        <ul>
            ...
            <li><span><?php echo htmlspecialchars($book->tenbanphim); ?></span></li>
        </ul>
    </div>
    ...
    <div class="box-block-main-content">
        <div class="block-detail-product">
            <div class="flex-item">
                        ...
                        <?php if (!empty($images)): ?>
                            <?php foreach ($images as $image): ?>
                                <div class="img-thum-detail-product">
                                    <img src="<?php echo BASE_URL . htmlspecialchars($image->duongdananh); ?>" alt="<?php echo htmlspecialchars($book->tenbanphim); ?>">
                                </div>
                            <?php endforeach; ?>
                        <?php else: ?>
                ...
                <div class="block-right-detail-product">
                    <h1 class="txt-name-product"><?php echo htmlspecialchars($book->tenbanphim); ?></h1>
                    <div class="code-product">
                        <p><b>Mã sản phẩm:</b> BK<?php echo sprintf("%04d", $book->idbanphim); ?></p>
                    </div>
                    <div class="thuonghieu">
                        <span><b>Thương hiệu:</b> <?php echo htmlspecialchars($book->tenthuonghieu); ?></span>
                    </div>
                    ...
                    <div class="block-add-to-cart">
                        <form id="add-to-cart-form">
                            ...
                            <input type="hidden" name="idSach" value="<?php echo htmlspecialchars($book->idbanphim); ?>">
        ...
        <div class="block-description">
            <h1 class="txt-description"><span>Giới thiệu sản phẩm</span></h1>
            <h2 class="block-title-description">Thông tin chi tiết</h2>
            <div class="box-note-product">
                <p>Thương hiệu: <?php echo htmlspecialchars($book->tenthuonghieu); ?></p>
                <p>Nhà phân phối: <?php echo htmlspecialchars($book->tennpp); ?></p>
            </div>
        ...
        <div class="block-item-products block-item-products-like">
            <h1 class="text-title">Sản phẩm liên quan</h1>
                        ...
                        <div class="item-product">
                            <div class="box-item-product">
                                <div class="img-item-product">
                                    <a href="index.php?pg=chitietsp&id=<?php echo htmlspecialchars($related->idbanphim); ?>">
                                        <img src="<?php echo BASE_URL . htmlspecialchars($related->anhbia); ?>" alt="<?php echo htmlspecialchars($related->tenbanphim); ?>">
                                    </a>
                                </div>
                                <div class="box-description-item">
                                    <a href="index.php?pg=chitietsp&id=<?php echo htmlspecialchars($related->idbanphim); ?>">
                                        <h1><?php echo htmlspecialchars($related->tenbanphim); ?></h1>
                                        <h2>Thương hiệu: <?php echo htmlspecialchars($related->tenthuonghieu); ?></h2>
                                    </a>
                                    <div class="price">
                                    ...
                                    <div class="box-add-to-card">
                                        <i class="icon-cart cartModal" data-id="modal-them-vao-gio-hang" data-idbanphim="<?php echo htmlspecialchars($related->idbanphim); ?>"></i>
                                        <button class="green buy-now-custom" data-idbanphim="<?php echo htmlspecialchars($related->idbanphim); ?>">Mua ngay</button>
                                    </div>
                                </div>
                            </div>
                        </div>
