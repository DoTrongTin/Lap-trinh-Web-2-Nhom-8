                                ...
                                <div class="item-product">
                                    <div class="box-item-product">
                                        <div class="img-item-product">
                                            <a href="../controller/index.php?pg=chitietsp&id=${book.idbanphim}">
                                                <img src="<?php echo BASE_URL; ?>${book.anhbia}" alt="${book.tenbanphim}">
                                            </a>
                                        </div>
                                        <div class="box-description-item">
                                            <a href="../controller/index.php?pg=chitietsp&id=${book.idbanphim}">
                                                <h1>${book.tenbanphim}</h1>
                                                <h2>Thương hiệu: ${book.tenthuonghieu}</h2>
                                            </a>
                                            <div class="price">
                                            ...
                                            <div class="box-add-to-card">
                                                <i class="icon-cart dataModal" data-id="modal-them-vao-gio-hang" data-idbanphim="${book.idbanphim}"></i>
                                                <button class="green buy-now" data-idbanphim="${book.idbanphim}">Mua ngay</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>`;
...
$(document).ready(function() {
    ...
    $(document).on('click', '.buy-now', function() {
        ...
        var idSach = $(this).data('idbanphim'); // Lấy idbanphim từ data-idbanphim
