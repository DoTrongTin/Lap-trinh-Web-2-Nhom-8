...
<head>
    ...
    <title>UniKeys - Bàn phím & Keycap</title>
</head>
<body class="mrtung">
    <div class="wrapper">
        <header>
                ...
                <div class="flex-item box-block-top-menu">
                    <div class="block-logo">
                        <a href="../controller/index.php">
                            <img src="../view/resources/images/logo-unikey-1.png" alt="UniKeys">
                        </a>
                    </div>
                    <?php
                            ...
                            let cartItemHtml = `
                                <div class="box-item-buy">
                                    ...
                                    <div class="box-description-buy">
                                        <h1><a href="../controller/index.php?pg=chitietsp&id=${item.idbanphim}" class="book-link">${item.tenbanphim}</a></h1>
